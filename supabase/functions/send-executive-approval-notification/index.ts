              ...
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f5f5f5; padding: 20px;">
                <div style="background-color: #ffffff; border-radius: 12px; padding: 30px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                  ...
                  <div style="text-align: center; margin-bottom: 25px;">
                    <a href="${Deno.env.get('FRONTEND_URL') || 'https://guestfeedback.lovable.app'}/executive-oversight" style="background: linear-gradient(135deg, #dc2626, #991b1b); color: white; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: bold; display: inline-block;">View Executive Dashboard</a>
                  </div>
