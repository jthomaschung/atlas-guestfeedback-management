  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          I'll add a credit to your account for a free original sandwich to make it right. We will use your phone number to add the credit and this credit is only applicable at the store where your original purchase was made.
        </Text>
