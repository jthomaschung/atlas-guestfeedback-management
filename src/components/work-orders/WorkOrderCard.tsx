...
export function WorkOrderCard({ workOrder, onEdit, onViewDetails, onDelete, isAdmin }: WorkOrderCardProps) {
  ...
  return (
    <Card className={cn(
      "group hover:shadow-[0_10px_25px_-5px_hsl(55_60%_92%_/_0.3),_0_4px_6px_-2px_hsl(55_60%_92%_/_0.15)] transition-all duration-200 hover:scale-[1.02] cursor-pointer",
