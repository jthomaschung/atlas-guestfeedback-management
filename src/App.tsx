...
function ProtectedRoute({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider>
      {/* Global red accent line - rendered ONCE at app shell level */}
      <div className="fixed top-0 left-0 right-0 h-1 bg-primary z-50" />
      
      <div className="min-h-screen flex w-full overflow-hidden pt-1">
        <AppSidebar />
        <div className="flex-1 flex flex-col min-w-0 pt-0">
          <header className="relative h-16 flex items-center justify-between bg-atlas-dark pl-3 pr-6 sticky top-1 z-40 mt-0">
